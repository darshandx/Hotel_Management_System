...
class Food implements Serializable
{
    ...
    Food(int itemno,int quantity)
    {
        ...
        switch(itemno)
        {
            case 1:price=quantity*50-100;
                break;
            case 2:price=quantity*30;
                break;
            case 3:price=quantity*200;
                break;
            case 4:price=quantity*200;
                break;
        }
    }
}
class Singleroom implements Serializable
{
    ...
    Singleroom(String name,String contact,String aadhar,String gender)
    {
        this.name=name;
...
{ 
    ...
    Doubleroom(String name,String contact,String aadhar,String gender,String name2,String contact2,String aadhar2,String gender2)
    {
        this.name=name;
        this.contact=contact;
        this.aadhar=aadhar;
...
class Hotel
{
    ...
    {
        String name, contact, aadhar, gender;
        String name2 = null, contact2 = null, aadhar2 = null;
        String gender2="";
        System.out.print("\nEnter customer name: ");
        name = sc.next();
        ...
        gender2 = sc.next();
          ...
          switch (i) {
            case 1:hotel_ob.luxury_doublerrom[rn]=new Doubleroom(name,contact,aadhar,gender,name2,contact2,aadhar2,gender2);
                break;
            case 2:hotel_ob.deluxe_doublerrom[rn]=new Doubleroom(name,contact,aadhar,gender,name2,contact2,aadhar2,gender2);
                break;
            case 3:hotel_ob.luxury_singleerrom[rn]=new Singleroom(name,contact,gender,aadhar);
                break;
            case 4:hotel_ob.deluxe_singleerrom[rn]=new Singleroom(name,contact,gender,aadhar);
                break;
    ...
    {
        double amount=0;
        String list[]={"Sandwitch,Coke,Pongal,Poori,Chappati,Meals,Biriyani (v/nv),Paratha)"};
        System.out.println("\n*******");
    ...
    static void order(int rn,int rtype)
    {
        ...
        char wish;
         try{
             System.out.println("\n==========\n   Menu:  \n==========\n\n1.Sandwich\tRs.50\n2.Pasta\t\tRs.60\n3.Noodles\tRs.70\n4.Coke\t\tRs.30\n5.Chappati/poori\tRs.20(1pc)\n6 pongal\tRs.50\n7.Meals\t\tRs.200\n8.Biriyani(v/nv)\tRs.200\n");
        do
        {
            i = sc.nextInt();
